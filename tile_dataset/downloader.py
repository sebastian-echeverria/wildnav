...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", type=str, default="./tiles", help="Output folder")
    ...
    if arguments.m is not None:
        ...
        csv_generator.write_map_csv_coordinates(map_data, os.path.join(output_folder, MAP_CSV_FILE))
    else:
